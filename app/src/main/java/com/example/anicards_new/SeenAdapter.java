...
public class SeenAdapter extends RecyclerView.Adapter<SeenAdapter.ViewHolder> {
    ...
    private List<AnimeSeen> mData; //class dos AnimeLiked
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    SeenAdapter(Context context, List<AnimeSeen> data04) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AnimeSeen anime = mData.get(position);
        holder.tvTitle.setText(anime.getTitle());
        holder.tvdate.setText(anime.getDate());

        final String animeTitle = anime.getTitle();
