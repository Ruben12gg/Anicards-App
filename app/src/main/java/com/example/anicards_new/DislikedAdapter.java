...
public class DislikedAdapter extends RecyclerView.Adapter<DislikedAdapter.ViewHolder> {

    //criação de referencias
    private List<AnimeDisliked> mData; //class dos AnimeLiked
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    DislikedAdapter(Context context, List<AnimeDisliked> data02) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        AnimeDisliked anime = mData.get(position);
